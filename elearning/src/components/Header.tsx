      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between h-20 px-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:block">
                ...
                <div className="flex items-center mt-1 space-x-2">
                  ...
                  <p className="text-gray-400 text-sm font-medium">Campus Virtual</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <a href="/Course" className="text-gray-300 hover:text-white transition-colors flex items-center space-x-2 group">
              <BookOpen className="h-5 w-5 group-hover:text-blue-400" />
              <span>Mis Cursos</span>
            </a>
            <a href="/calendar" className="text-gray-300 hover:text-white transition-colors flex items-center space-x-2 group">
            ...
            <Dropdown 
              trigger={
                <button className="flex items-center space-x-3 p-1.5 rounded-lg hover:bg-gray-800/50 transition-colors">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center ring-2 ring-blue-500/20">
